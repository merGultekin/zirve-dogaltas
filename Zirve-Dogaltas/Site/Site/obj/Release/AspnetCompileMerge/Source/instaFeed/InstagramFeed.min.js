        ...
        this.display = function(data) {
            ...
            if (this.options.display_gallery) {
                ...
                if (typeof data.is_private !== "undefined" && data.is_private === true) {
                    ...
                    html += "<div class='instagram_gallery'><ul class='owl-carousel owl-theme'>";
                    ...
                    for (var i = 0; i < max; i++) {
                        ...
                        html += "<li class='item'><a href='" + url + "' class='instagram-" + type_resource + "' title='" + caption + "' rel='noopener' target='_blank'>";
                        html += "<img" + (this.options.lazy_load ? " loading='lazy'" : '')  + " src='" + image + "' alt='" + caption + "' />";
                        html += "<span class='caption'>" + caption + "</span></a></li>";
                    }
